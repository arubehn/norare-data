    ...
    try:
        with open(filename) as f:
            ...
            for row in reader:
                ...
                cue_res = mappings["es"][cue]
                response_res = mappings["es"][response]
...
def map(dataset, concepticon, mappings):
    r1_data = extract_data(dataset.raw_dir / "strength.SWOWRP.R1.20220426.csv", mappings)
    r123_data = extract_data(dataset.raw_dir / "strength.SWOWRP.R123.20220426.csv", mappings)
